  ...
  return (
    <section
      ...
      <motion.h1
        ...
        <span className="font-bold">Hello, I'm Abishek.</span> I'm a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">good</span> of experience. I enjoy
      ...
      <motion.div
        ...
        <a
          ...
          href="https://www.linkedin.com/in/abhishek-067946261/"
          target="_blank">
          <BsLinkedin />
        </a>
